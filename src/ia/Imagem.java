...
class Imagem {
    ...
    public byte[][] converter(String aluno, String imagem, String tipo) throws IOException {
        ...
        String urlImagem = "Users/AgtLucas/NetBeansProjects/ApplicationIA/IA/imagens/" + aluno + "_" + imagem + "_" + tipo + especificacao;        
    ...
    public void cabecalhoImagem(int patterns, String inputs, String outputs) throws IOException {                
        FileWriter arq = new FileWriter("Users/AgtLucas/NetBeansProjects/ApplicationIA/IA/_numeros.pat");
    ...
    public void cabecalhoAluno(int patterns, String inputs, String outputs) throws IOException {                
        FileWriter arq = new FileWriter("Users/AgtLucas/NetBeansProjects/ApplicationIA/IA/_alunos.pat");
        PrintWriter gravarArq = new PrintWriter(arq);                        
        String cabecalho = 
                "SNNS pattern definition file V3.2" +
                "\n" + 
    ...
    public void imprimirImagem(byte[][] imagem, String aluno, String caracter, String tipo) throws IOException {                                 
        ...
        try (FileWriter arq = new FileWriter("Users/AgtLucas/NetBeansProjects/ApplicationIA/IA/_numeros.pat", true)) {
            PrintWriter gravarArq = new PrintWriter(arq);
    ...
    public void imprimirAluno(byte[][] imagem, String aluno, String caracter, String tipo) throws IOException {                                 
        Imagem imp = new Imagem();
        try (FileWriter arq = new FileWriter("Users/AgtLucas/NetBeansProjects/ApplicationIA/IA/_alunos.pat", true)) {
            PrintWriter gravarArq = new PrintWriter(arq);
            gravarArq.printf("#Entrada: " + caracter + " - " + aluno);
            gravarArq.printf("\n");
            for (int i = 0; i < imagem.length; i++) {
